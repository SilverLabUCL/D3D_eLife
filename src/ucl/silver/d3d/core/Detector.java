...
public class Detector extends ParamVector {
    ...
    private Color defaultColor = new Color(102, 153, 0);
    ...
    public void detect(RunFiniteDifference fd, Geometry geometry) {
        ...
        save.saveData(fd.diffus, diffusantNum, coordinates().index);

        return;

    }

    public void detect(RunMonteCarlo mc, Geometry geometry) {
        ...
        int xVoxel2 = coordinates().xVoxel2;
        int yVoxel2 = coordinates().yVoxel2;
        int zVoxel2 = coordinates().zVoxel2;
