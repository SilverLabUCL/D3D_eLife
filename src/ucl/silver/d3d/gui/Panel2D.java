...
public class Panel2D
    ...
    private String comboEditString = "Diffusant.0"; // All";
    ...
    public void updateControls() {
        ...
        displayModeUpdate();
        displayModeSet(comboEditString);
        objectColorUpdate();
        zoomSliderUpdate();
    ...
    public void displayModeSet(String eSelect) {
        ...
        if ((emode >= 0) && (emode <= 4)) {
            ...
            comboEditString = "Diffusant.0";
            grid2D.setViewMode(1);
            grid2D.setViewArrayNum(0);
        }
    ...
    public void coordinatesDimToggle() {
        ...
        if (grid2D.coordVoxels) {
            grid2D.coordVoxels = false;
        } else {
            grid2D.coordVoxels = true;
        }
    ...
    public void coordinatesClickToggle() {
        ...
        if (grid2D.coordClick) {
            grid2D.coordClick = false;
        } else {
            grid2D.coordClick = true;
        }
    ...
    void sliderZoom_stateChanged(ChangeEvent e) {
        ...
        grid2D.setVoxelWidth(v.intValue());
    }
